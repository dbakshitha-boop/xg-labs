...
function Group() {
  return (
    <div className="absolute contents left-[713px] top-[100.77px]">
      <div className="absolute flex h-[488.678px] items-center justify-center left-[738px] top-[111.41px] w-[444.127px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[354.11deg]">
          <Testi />
        </div>
      </div>
      <div className="absolute flex h-[523.344px] items-center justify-center left-[713px] top-[111.06px] w-[494.034px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[348.216deg] skew-x-[0.436deg]">
          <Purple />
        </div>
      </div>
      <div className="absolute flex h-[476.811px] items-center justify-center left-[741px] top-[111.33px] w-[438.605px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[356.074deg] skew-x-[0.149deg]">
          <Grey />
        </div>
      </div>
      <div className="absolute flex h-[512.633px] items-center justify-center left-[719px] top-[100.77px] w-[481.04px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[350.182deg] skew-x-[0.367deg]">
          <Testi1 />
        </div>
      </div>
      <div className="absolute flex h-[501.298px] items-center justify-center left-[726.19px] top-[151.23px] w-[467.458px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
